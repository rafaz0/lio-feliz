...
> **Inicialização rápida:** Utilize `PROJECT_BOOTSTRAP.md` (v2.19) como Runtime Operacional. Este documento (`DOCUMENTACAO_COMPLETA.md`) é a Fonte Canônica para consulta quando necessário.
