...
export class ObterQuestionarioService
  implements IApplicationService<ObterQuestionarioQuery, QuestionarioPerguntasDto[]>
{
  private readonly classifier = new RiskClassifier();

  async Execute(_query: ObterQuestionarioQuery): Promise<QuestionarioPerguntasDto[] | ApplicationError> {
