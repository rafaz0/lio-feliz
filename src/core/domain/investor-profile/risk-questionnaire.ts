...
export class RiskQuestionnaire extends ValueObject<RiskQuestionnaireProps> {
  private constructor(props: RiskQuestionnaireProps) {
    super(props);
  }
  static create(props: RiskQuestionnaireProps): RiskQuestionnaire {
    return new RiskQuestionnaire(props);
  }
  get id(): RiskQuestionnaireId {
