...
describe("AmortizationEvent", () => {
  describe("creation", () => {
    it("creates an amortization event with given properties", () => {
      const event = new AmortizationEvent("portfolio-1", "corr-1", "PETR4", 100, 2.5);
    ...
    it("sets type to AMORTIZATION", () => {
      const event = new AmortizationEvent("p1", "c1", "PETR4", 100, 2.5);
  ...
  describe("eventId", () => {
    ...
    it("is unique across instances", () => {
      const a = new AmortizationEvent("p1", "c1", "PETR4", 100, 2.5);
      const b = new AmortizationEvent("p1", "c2", "VALE3", 50, 1.0);
  ...
  describe("edge cases", () => {
    it("handles zero shares", () => {
      const event = new AmortizationEvent("p1", "c1", "PETR4", 0, 2.5);
    ...
    it("handles fractional shares", () => {
      const event = new AmortizationEvent("p1", "c1", "PETR4", 10.5, 2.0);
