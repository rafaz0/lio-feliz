...
describe("BuyEvent", () => {
  describe("creation", () => {
    it("creates a buy event with given properties", () => {
      const event = new BuyEvent("portfolio-1", "corr-1", "PETR4", 100, 25.50);
  ...
  describe("eventId", () => {
    ...
    it("is unique across instances", () => {
      const a = new BuyEvent("p1", "c1", "PETR4", 100, 25.50);
      const b = new BuyEvent("p1", "c2", "VALE3", 50, 60.00);
  ...
  describe("edge cases", () => {
    it("handles zero quantity", () => {
      const event = new BuyEvent("p1", "c1", "PETR4", 0, 25.50);
    ...
    it("handles fractional quantities", () => {
      const event = new BuyEvent("p1", "c1", "PETR4", 10.5, 25.50);
