...
import {
  FakeRebalancingDispatcher,
  type FakeRebalancingDispatcherOptions,
} from "./fake-dispatcher";
...
export function createFakeDispatcher(
  options: FakeRebalancingDispatcherOptions = {},
): FakeRebalancingDispatcher {
  return new FakeRebalancingDispatcher(options);
}
