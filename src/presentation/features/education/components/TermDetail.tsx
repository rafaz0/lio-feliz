    ...
    <div className="space-y-4">
      ...
      <div className="rounded-lg border p-4 space-y-3">
        ...
        {term.synonyms.length > 0 && (
          <div>
            <span className="text-xs font-medium text-muted-foreground">Sinonimos: </span>
            <span className="text-xs">{term.synonyms.join(", ")}</span>
          </div>
        )}
        {term.relatedTerms.length > 0 && (
          <div>
            <span className="text-xs font-medium text-muted-foreground">Termos relacionados: </span>
            <span className="text-xs">{term.relatedTerms.join(", ")}</span>
          </div>
        )}
      </div>
    </div>
