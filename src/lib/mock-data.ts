...
const seeds: Seed[] = [
  {
    ...
    f: { pl: 4.2, pvp: 1.1, dy: 14.8, roe: 27.3, roic: 21.4, margemLiquida: 22.1, divLiquidaEbitda: 0.9, lpa: 9.21, vpa: 35.4, marketCap: 505_000_000_000 },
  },
  {
    ticker: "VALE3",
    name: "Vale ON",
    ...
    f: { pl: 5.6, pvp: 1.4, dy: 9.7, roe: 24.1, roic: 18.2, margemLiquida: 25.4, divLiquidaEbitda: 0.6, lpa: 11.15, vpa: 44.6, marketCap: 285_000_000_000 },
  },
  {
    ticker: "ITUB4",
    ...
    f: { pl: 9.1, pvp: 1.8, dy: 5.6, roe: 20.4, roic: 15.1, margemLiquida: 27.8, divLiquidaEbitda: 0, lpa: 3.75, vpa: 19.1, marketCap: 335_000_000_000 },
  },
  {
    ticker: "BBAS3",
    ...
    f: { pl: 4.7, pvp: 0.9, dy: 10.2, roe: 20.9, roic: 12.4, margemLiquida: 24.6, divLiquidaEbitda: 0, lpa: 5.94, vpa: 30.6, marketCap: 158_000_000_000 },
  },
  {
    ticker: "BBDC4",
    name: "Bradesco PN",
    ...
    f: { pl: 8.4, pvp: 1.0, dy: 6.8, roe: 12.1, roic: 8.5, margemLiquida: 15.4, divLiquidaEbitda: 0, lpa: 1.74, vpa: 14.7, marketCap: 155_000_000_000 },
  },
  {
    ticker: "WEGE3",
    name: "WEG ON",
    ...
    f: { pl: 32.1, pvp: 7.4, dy: 1.5, roe: 24.6, roic: 22.1, margemLiquida: 15.2, divLiquidaEbitda: 0.1, lpa: 1.24, vpa: 5.4, marketCap: 167_000_000_000 },
  },
  {
    ticker: "MGLU3",
    ...
    f: { pl: 42.3, pvp: 2.1, dy: 0.2, roe: 5.1, roic: 4.3, margemLiquida: 1.8, divLiquidaEbitda: 2.4, lpa: 0.19, vpa: 3.9, marketCap: 55_000_000_000 },
  },
  {
    ticker: "ITSA4",
    name: "Itaúsa PN",
    ...
    f: { pl: 7.1, pvp: 1.1, dy: 7.4, roe: 15.4, roic: 12.1, margemLiquida: 42.1, divLiquidaEbitda: 0, lpa: 1.51, vpa: 9.6, marketCap: 116_000_000_000 },
  },
  {
    ticker: "B3SA3",
    name: "B3 ON",
    ...
    f: { pl: 15.3, pvp: 2.4, dy: 6.1, roe: 15.7, roic: 12.4, margemLiquida: 52.8, divLiquidaEbitda: 1.2, lpa: 0.81, vpa: 5.1, marketCap: 74_000_000_000 },
  },
  {
    ticker: "SUZB3",
    name: "Suzano ON",
    ...
    f: { pl: 6.8, pvp: 1.6, dy: 2.4, roe: 24.2, roic: 15.6, margemLiquida: 21.8, divLiquidaEbitda: 2.8, lpa: 8.07, vpa: 34.3, marketCap: 74_000_000_000 },
  },
  {
    ticker: "ELET3",
    name: "Eletrobras ON",
    ...
    f: { pl: 11.4, pvp: 0.9, dy: 3.2, roe: 8.4, roic: 6.8, margemLiquida: 18.4, divLiquidaEbitda: 2.1, lpa: 3.61, vpa: 45.8, marketCap: 95_000_000_000 },
  },
  {
    ticker: "CSNA3",
    name: "CSN ON",
    ...
    f: { pl: 8.9, pvp: 1.1, dy: 4.3, roe: 12.4, roic: 8.6, margemLiquida: 9.2, divLiquidaEbitda: 3.4, lpa: 1.67, vpa: 13.5, marketCap: 21_000_000_000 },
  },
  {
    ticker: "USIM5",
    name: "Usiminas PNA",
    ...
    f: { pl: 12.6, pvp: 0.5, dy: 3.8, roe: 4.1, roic: 3.2, margemLiquida: 3.8, divLiquidaEbitda: 1.5, lpa: 0.51, vpa: 12.4, marketCap: 8_000_000_000 },
  },
  {
    ticker: "GGBR4",
    name: "Gerdau PN",
    ...
    f: { pl: 6.1, pvp: 0.9, dy: 8.2, roe: 15.6, roic: 12.8, margemLiquida: 10.4, divLiquidaEbitda: 0.4, lpa: 3.01, vpa: 20.1, marketCap: 39_000_000_000 },
  },
  {
    ticker: "PRIO3",
    name: "PRIO ON",
    ...
    f: { pl: 5.4, pvp: 2.1, dy: 3.2, roe: 42.1, roic: 34.5, margemLiquida: 44.2, divLiquidaEbitda: 0.8, lpa: 7.80, vpa: 20.0, marketCap: 36_000_000_000 },
  },
  {
    ticker: "RENT3",
    name: "Localiza ON",
    ...
    f: { pl: 18.4, pvp: 2.6, dy: 1.4, roe: 15.2, roic: 10.4, margemLiquida: 12.8, divLiquidaEbitda: 3.6, lpa: 2.27, vpa: 16.1, marketCap: 42_000_000_000 },
  },
  {
    ticker: "ABEV3",
    name: "Ambev ON",
    ...
    f: { pl: 11.8, pvp: 2.1, dy: 5.4, roe: 18.4, roic: 15.2, margemLiquida: 21.4, divLiquidaEbitda: 0, lpa: 1.12, vpa: 6.3, marketCap: 208_000_000_000 },
  },
  {
    ticker: "HAPV3",
    name: "Hapvida ON",
    ...
    f: { pl: 24.6, pvp: 1.4, dy: 0, roe: 5.8, roic: 4.6, margemLiquida: 4.2, divLiquidaEbitda: 2.1, lpa: 0.15, vpa: 2.6, marketCap: 27_000_000_000 },
  },
  {
    ticker: "VIVT3",
    ...
    f: { pl: 15.4, pvp: 1.4, dy: 6.8, roe: 8.9, roic: 7.1, margemLiquida: 12.4, divLiquidaEbitda: 0.6, lpa: 3.32, vpa: 36.6, marketCap: 84_000_000_000 },
  },
  {
    ticker: "CMIG4",
    name: "Cemig PN",
    ...
    f: { pl: 5.1, pvp: 1.1, dy: 11.4, roe: 21.4, roic: 14.6, margemLiquida: 17.2, divLiquidaEbitda: 1.4, lpa: 2.32, vpa: 10.8, marketCap: 33_000_000_000 },
  },
  {
    ticker: "TAEE11",
    name: "Taesa UNT",
    ...
    changeDayPct: -0.28,
    description:
      "A Taesa é uma das maiores empresas de transmissão de energia elétrica do Brasil.",
    f: { pl: 8.2, pvp: 1.9, dy: 10.8, roe: 22.4, roic: 12.6, margemLiquida: 44.8, divLiquidaEbitda: 2.8, lpa: 4.32, vpa: 18.6, marketCap: 12_000_000_000 },
  },
];
